...
export class WinScene extends Container {
    ...
    constructor({ app }: Game) {
        ...
        this.descriptiveText = new Text('Ты разгадал мехнизм и находишь подсказку,\nкоторая ведёт тебя к очередному свидетелю.', new TextStyle({
            fontFamily: 'Arial',
            fontSize: 32,
            fill: 0xffffff,
            align: 'center'
        ...
        this.button.on('pointerdown', () => {
            ...
            SoundManager.playSound("witness_4");
