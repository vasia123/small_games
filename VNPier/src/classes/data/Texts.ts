...
export const dialogs: Dialogs = {
    ...
    "homeless_walk_bad": {
        location: "bg_homeless",
        message: "Ты пытаешься пройти мимо бездомных, стараясь не обращать на себя внимания. Однако бородатый мужчина замечает тебя и встаёт, блокируя тебе путь. Он требует знать, что ты делаешь в их укрытии. Ты пытаешься объяснить, что просто исследуешь туннели, но его голос становится все грознее. В итоге, он грубо толкает тебя в сторону, указывая выход. Тебе приходится покинуть туннель.",
        options: {
            "Уйти": "third_junction",
            "Завести разговор": "homeless_talk",
            "Попытаться пройти мимо": "bats",
