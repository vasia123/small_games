...
export const dialogs: Dialogs = {
    ...
    "ep1": {
        location: "bg_3_dark",
        message: "Ты осторожно спускаешься по железной лестнице, чувствуя, как холод и сырость усиливаются с каждым шагом. \n\nЗвук твоих шагов эхом разносится вглубь туннеля. Спрыгнув с лестницы, ты оказываешься в темном, обветшалом туннеле.",
        options: {
    ...
    "ep2": {
        location: "bg_3",
        message: "Пока твой фонарик скользит по заброшенному туннелю, в воздухе витает мертвая тишина, нарушаемая лишь еле слышным капанием воды где-то вдалеке. \n\nСтены туннеля, увитые пеленой мха и лишайников, как будто шепчут о забытых эпохах. Поверхность их неровная, а контуры имеют странные изгибы, как будто когти огромного зверя царапали их на протяжении столетий.",
        options: {
    ...
    "take_crowbar": {
        ...
        message: "Ты наклоняешься и осторожно поднимаешь ломик. \n\nОн тяжелый, и ты можешь почувствовать холод металла даже через перчатки. Чутье подсказывает, что это инструмент стал свидетелем историй, которые могли бы заставить кровь стынуть в жилах. \n\nПохоже, этот туннель хранит свои тайны крепко, и стены здесь говорят на языке, которому следует прислушиваться очень внимательно.",
        options: {
            "Идти дальше": "first_junction",
        },
        guard: () => {
    ...
    "center_tunnel": {
        ...
        sound: "main_theme",
        message: "Центральный туннель кажется самым старым. Стены здесь выглядят изношенными, и пол устлан осколками кирпичей и камней.",
        options: {
            "Идти дальше": "rat",
    ...
    "second_junction": {
        location: "bg_2",
        sound: "main_theme",
        message: "Продвигаясь дальше по туннелю, ты замечаешь перед собой ещё одну развилку.\n\nСначала ты даже подумал, что случайно вернулся к той, на которой уже был, но вглядевшись, понимаешь, что это другая. Мох на стенах тут темнее, и его текстура несколько иная.Также, в воздухе плывет лёгкий аромат, которого не был на первой развилке.\n\nВ каждом из этих туннелей может скрываться что-то, что поможет тебе в расследовании. Какой путь ты выберешь?",
        options: {
    ...
    "second_left_tunnel": {
        location: "bg_1",
        message: "Ты двигаешься по мокрому туннелю, и твой фонарик освещает путь впереди. Вода вокруг твоих ботинок становится глубже, и ты начинаешь чувствовать неприятный холод. Запах становится все более густым и смешивается с запахом гнили и болота. Твои шаги вызывают небольшие волны, которые бьются о стены туннеля.",
        options: {
    ...
    "crocodile_run": {
        location: "bg_empty_tunnel",
        sound: "main_theme",
        message: "Решив, что схватка с крокодилом равносильна самоубийству, ты молниеносно разворачиваешься и бросаешься наутек. По туннелю ты несешься с бешеной скоростью, расплескивая воду вокруг.\n\nЗа спиной слышен рык крокодила и плеск воды, но оглядываться нет времени. Бег продолжается до тех пор, пока ты не покидает водную зону и не оказываешься в сухой части туннеля. Похоже, опасность осталась позади.",
        options: {
    ...
    "second_center_tunnel": {
        location: "",
        message: "Ты пересекаешь вторую развилку и выбираешь центральный проход.\n\nПродвигаясь всё дальше и даль твои шаги находят ритм в этом древнем туннеле. Воздух становится прохладнее, и ты слышишь слабый шепот ветра, проходящего через тесные проходы канализации.\n\nСтены, усыпанные каплями конденсата, кажутся живыми, словно они тоже внимательно следят за тобой.\n\nВскоре ты замечаешь слабое свечение впереди и до тебя доносятся обрывки звуков.",
        options: {
    ...
    "third_junction": {
        location: "bg_2",
        message: "Ты продолжаешь свой путь по темному туннелю. Вскоре, звуки твоих шагов приобретают отголоски, и ты осознаешь, что попадаешь в более просторное помещение. Твой фонарик раскрывает перед тобой третью развилку.\n\nНа этот раз развилка отличается от двух предыдущих. Это кажется старым и заброшенным залом с тремя проходами, уходящими в разные направления. На стенах меньше мха чем в предыдущих залах, а под потолком тянутся обвисшие гирлянды паутины.",
        options: {
            "Идти в левый туннель": "third_left_tunnel",
            "Идти в правый туннель": "good_end",
            "Идти в центральный туннель": "third_center_tunnel",
        }
    },
    "third_left_tunnel": {
        location: "bg_empty_tunnel",
        message: "Ты решаешь двигаться по узкому туннелю слева. С каждым шагом аромат становится все гуще, и ты начинаешь чувствовать слабое покалывание на коже. В конце туннеля виднеется что-то, что напоминает маленькую камеру. Твой фонарик едва пробивает мрак, и ты входишь внутрь.",
        options: {
            "Идти дальше": "bats",
        }
    },
    "bats": {
        location: "bg_bats",
        message: "Сначала ты ничего не замечаешь, но когда свет твоего фонаря медленно скользит по стенам, ты замечаешь движение. Ты поднимаешь фонарик выше и видишь, что камера полна летучих мышей, висящих на потолке. Вдруг, будто сигнал к действию, они все сразу взлетают в воздух с резким, тревожным шумом крыльев.\n\nТы отшатываешься назад, сердце стучит как сумасшедшее, но полчище мышей пролетает мимо тебя, они касаются тебя своими крыльями, но не причиняют вреда. Мыши быстро исчезают в темноте туннеля, оставляя тебя одного в тупике.",
        options: {
